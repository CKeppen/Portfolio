...
![Lab Network Diagram](images/Pasted_image_20260419184046.png)
...
![VirtualBox New VM button](images/Pasted_image_20260411165745.png)
...
![VM Wizard - Name and OS](images/Pasted_image_20260411170242.png)
...
![VM Wizard - Hardware](images/Pasted_image_20260411171655.png)

Afterwards, a summary page for review to finish the creation of the `.vdi` and `.vbox` files.

![VM Wizard - Summary](images/Pasted_image_20260411171733.png)

I did this for both the Server and Client, shown below.

![Server and Client VMs created](images/Pasted_image_20260411172143.png)
...
![Network Settings menu](images/Pasted_image_20260411174126.png)
...
Server Adapter 1:
![Server Adapter 1 - NAT](images/Pasted_image_20260411173728.png)
...
Server Adapter 2: 
![Server Adapter 2 - Internal Network](images/Pasted_image_20260411173843.png)
...
Client Adapter 1: 
![Client Adapter 1 - Internal Network](images/Pasted_image_20260411174401.png)
...
![Storage settings with .vdi](images/Pasted_image_20260411173404.png)
...
![Connecting the .iso to the optical drive](images/Pasted_image_20260411175630.png)
...
![Both Windows VMs running](images/Pasted_image_20260411180936.png)
...
![VM shutdown options](images/Pasted_image_20260411181557.png)
...
![Connecting VBox Guest Additions .iso](images/Pasted_image_20260411181422.png)

When I'm back in the VM, I can see a disc drive for the VBox Guest Additions in the File Manager.

![VBox Guest Additions disc in File Manager](images/Pasted_image_20260411181706.png)

I choose the VBox WindowsAddition-amd64 application to run and install. Then reboot for a smoother experience.

![VBoxWindowsAdditions installer](images/Pasted_image_20260411181752.png)
...
![Snapshot tab in VirtualBox](images/Pasted_image_20260411182906.png)
...
![Kali pre-built VM download page](images/Pasted_image_20260411184752.png)
...
![VirtualBox Add button](images/Pasted_image_20260411165745.png)

![Kali .vbox added to VirtualBox](images/Pasted_image_20260411192051.png)
...
![Kali Adapter 1 - Internal Network](images/Pasted_image_20260411192111.png)

Run the Kali VM, enter the default login. Then you're in. Make a base Snapshot and this is now setup.

![Kali VM running](images/Pasted_image_20260411185459.png)

The VirtualBox now has a Windows Server, Windows Client and Kali system up and running.

![All three VMs in VirtualBox](images/Pasted_image_20260411185719.png)
...
![Network Connections - two adapters](images/Pasted_image_20260416171511.png)
...
![Ethernet adapter status comparison](images/Pasted_image_20260416172849.png)
...
![Renamed network adapters](images/Pasted_image_20260416172750.png)
...
![Internal adapter static IP configuration](images/Pasted_image_20260416173238.png)

Verification of the Internal card with the new IP and subnet, `192.168.10.0/24` for the Lab Network.

![Internal adapter IP verification](images/Pasted_image_20260416173608.png)
...
![Server Manager - Add Roles and Features](images/Pasted_image_20260416173932.png)
...
![Server selection confirmation](images/Pasted_image_20260416174207.png)
...
![AD DS installation progress](images/Pasted_image_20260416181944.png)

When the server reboots, this is now the login screen with the CYBERLAB domain. Success!

![CYBERLAB domain login screen](images/Pasted_image_20260416182323.png)

Now Server Manager has additional roles. AD DS and DNS. Success!

![Server Manager with AD DS and DNS roles](images/Pasted_image_20260418152655.png)
...
![Client static IP configuration](images/Pasted_image_20260416184830.png)

Now, for the final test. Does the Server and Client reflect this information? 

Client IP confirmed `192.168.10.2`
![Client IP confirmation](images/Pasted_image_20260416184945.png)

Server, confirmed NAT address of `10.0.2.15` and Internal address of `192.168.10.1`
![Server IP confirmation](images/Pasted_image_20260416185444.png)
...
![Active Directory Users and Computers - cyberlab.local](images/Pasted_image_20260418172138.png)
...
![Domain join dialog](images/Pasted_image_20260418172526.png)

An administrator login with popup for permissions. Using the admin account setup on the server, permission is granted.

![Admin credentials prompt for domain join](images/Pasted_image_20260418173025.png)
...
![Domain join welcome message](images/Pasted_image_20260418174125.png)
![Restart prompt](images/Pasted_image_20260418174153.png)
...
![Client login screen showing CYBERLAB domain](images/Pasted_image_20260418174432.png)

Success!

![Logged in as CYBERLAB Administrator](images/Pasted_image_20260418174512.png)
...
![Active Directory Computers showing client](images/Pasted_image_20260418175101.png)
...
![Client About PC showing domain](images/Pasted_image_20260418175133.png)
...
![New User option in AD](images/Pasted_image_20260418180435.png)
...
![New user - Cody Admin](images/Pasted_image_20260418181338.png)
...
![Password options for new user](images/Pasted_image_20260418181542.png)

Then hit finish after reviewing for any typos.

![New user summary](images/Pasted_image_20260418181605.png)
...
![Password Never Expires setting](images/Pasted_image_20260418181759.png)

Back to the Client, I log out of the Domain Administrator, and now the new Admin user. 

Success!

![Logged in as cody_admin](images/Pasted_image_20260418181923.png)
...
![Server Manager - Add Roles and Features](images/Pasted_image_20260418182415.png)

I'll go through the Wizard till I get to Server Roles and find Remote Access.

![Remote Access role selection](images/Pasted_image_20260418182557.png)

In "Role Services", I check "Routing" and "Add Features", which will also toggle on "DirectAccess and VPN(RAS)"

![Routing and RAS role services](images/Pasted_image_20260418182720.png)

At the end of the Wizard, I review, then Install.

![Remote Access installation confirmation](images/Pasted_image_20260418182844.png)

Once that is finished, on the Server still I'll go to Tools then Routing and Remote Access.

![Tools - Routing and Remote Access](images/Pasted_image_20260418183226.png)
...
![Routing and Remote Access - configure option](images/Pasted_image_20260418183401.png)
...
![NAT configuration - selecting Internet adapter](images/Pasted_image_20260418184027.png)
...
![Client Default Gateway set to Server IP](images/Pasted_image_20260418184922.png)
...
![All three VMs running in VirtualBox](images/Pasted_image_20260418191036.png)
...
![Snapshots list for VMs](images/Pasted_image_20260418191146.png)
...
![Client pinging Google DNS successfully](images/Pasted_image_20260418191805.png)
...
![AD DS running on Server](images/Pasted_image_20260418201557.png)

![DNS running on Server](images/Pasted_image_20260418201730.png)
...
![Server ping to Client - success after firewall change](images/Pasted_image_20260418194901.png)

Server Ping to Kali Test: Success
![Server ping to Kali](images/Pasted_image_20260418201347.png)

Client to Server Ping Test: Success
![Client ping to Server](images/Pasted_image_20260418201258.png)

Client to Kali Ping Test: Success
![Client ping to Kali](images/Pasted_image_20260418201331.png)
...
![Kali IP configuration](images/Pasted_image_20260418200126.png)

Kali Ping to Server Test: Success
![Kali ping to Server](images/Pasted_image_20260418200202.png)

## Kali Probe Demonstration

Kali Ping to Client Test: Windows Firewall block Success ([Firewall ICMP Block](#firewall-icmp-block))
![Kali ping to Client - blocked by firewall](images/Pasted_image_20260418200249.png)

Kali Nmap scan to Client to Bypass Firewall Ping Test: Success
![Kali Nmap scan results on Client](images/Pasted_image_20260418200838.png)
...
![SSD mounted as Lab Storage in File Manager](images/Pasted_image_20260410231527.png)
...
![Google DNS ping failing](images/Pasted_image_20260418190529.png)
...
![Two Internal Network cards in Routing and Remote Access](images/Pasted_image_20260418190618.png)
...
![Server-Client ping asymmetry](images/Pasted_image_20260418232603.png)
...
![Traceroute output](images/Pasted_image_20260418233551.png)
...
![Domain Firewall toggle - admin credentials prompt](images/Pasted_image_20260418233848.png)
...
![Side-by-side ping success with firewall off](images/Pasted_image_20260418233935.png)
