...
* **Technical Skills Examples**
  ...
  * [**Windows Virtual Machine Environment Setup**](https://github.com/CKeppen/Portfolio/blob/main/MS_Home_Lab_VM_Setup.md#virtual-machine-creation.md): This is my more advanced Home Lab setup with a Windows Environement. It includes a Windows Server, Windows Client and Kali VM, (02/04/2026).
