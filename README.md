...
* **Incident Response Analysis**
  ...
  * [**Network Attack and Log Analysis - Executing and Detecting Pass-The-Hash**](https://github.com/CKeppen/Portfolio/blob/main/Network_Attack_and_Log_Analysis-Executing_and_Detecting_Pass-the-Hash.md): Demonstrating the difference of a vulnerable and hardened system against Pass-The-Hash. Using tshark, WireShark for packet analysis and PowerShell for Firewall analysis.  
...
* **Certifications:**  SC-300 Identity and Access Management (IAM) Associate, CompTIA Security+, Google Cybersecurity Professional, AZ-900 Azure Fundamentals
* **Core Skills:** Data Analytics, Identity & Access Managmement (IAM), Incident Response, Documentation, Linux, Python, SQL
